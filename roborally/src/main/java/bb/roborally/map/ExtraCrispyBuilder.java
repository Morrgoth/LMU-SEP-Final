...
public class ExtraCrispyBuilder implements BoardBuilder {
    ...
    public GameStarted build() {
        ...
        ArrayList<ArrayList<Cell>> extraCrispy= new ArrayList<>();
        for (int x = 0; x < X_MAX; x++) {
            extraCrispy.add(new ArrayList<>());
            for (int y = 0; y < Y_MAX; y++) {
                extraCrispy.get(x).add(new Cell());
                for(int k = 0; k < maxCellContent; k++){
                    ...
                    if(x  == 0 && y ==  0){
                        if(k == 0){
                            ...
                            extraCrispy.get(x).get(y).addTile(restartPoint);
                        }
                    }
                    ...
                    if(x  == 1 && y ==  0){
                        if(k == 0){
                            ...
                            extraCrispy.get(x).get(y).addTile(empty);
                        }
                    }
                    ...
                    if(x  == 2 && y ==  0){
                        if(k == 0){
                            ...
                            extraCrispy.get(x).get(y).addTile(conveyorBelt);
                        }
                    }
                    ...
                    if(x  == 8 && y ==  0){
                        if(k == 0){
                            ...
                            extraCrispy.get(x).get(y).addTile(energySpace);
                        }
                    }
                    ...
                    if(x  == 9 && y ==  0){
                        if(k == 0){
                            ...
                            extraCrispy.get(x).get(y).addTile(laser);
                        }
                        if(k == 1){
                            ArrayList<Orientation> orientations = new ArrayList<>();
                            orientations.add(Orientation.LEFT);
                            Wall wall = new Wall("4A", orientations);
                            extraCrispy.get(x).get(y).addTile(wall);
                        }
                    }
                    ...
                    if(x  == 1 && y ==  1){
                        if(k == 0){
                            ...
                            extraCrispy.get(x).get(y).addTile(startPoint);
                        }
                    }
                    ...
                    if(x  == 5 && y ==  2){
                        ...
                        if(k == 2){
                            ...
                            extraCrispy.get(x).get(y).addTile(checkPoint);
                        }
                    }
                    ...
                    if(x  == 6 && y ==  2){
                        if(k == 0){
                            Pit pit = new Pit("4A");
                            extraCrispy.get(x).get(y).addTile(pit);
                        }
                    }
                    ...
                    if(x  == 0 && y ==  4){
                        if(k == 0){
                            ...
                            extraCrispy.get(x).get(y).addTile(antenna);
                        }
                    }
                    ...
                    if(x  == 6 && y ==  4){
                        if(k == 0){
                            ...
                            extraCrispy.get(x).get(y).addTile(gear);
                        }
                    }
        ...
        return new GameStarted(new Board(extraCrispy));
    }
}
