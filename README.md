...
```
cd existing_repo
git remote add origin https://gitlab2.cip.ifi.lmu.de/dbs_sep/dbs_sep2022/blinde_bonbons_hp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab2.cip.ifi.lmu.de/dbs_sep/dbs_sep2022/blinde_bonbons_hp/-/settings/integrations)
